...
@FacesConverter("levelFourRequestableConverter2")

public class LevelFourRequestableConverter2 implements Converter {
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
				...
				List<LevelFourRequestableRow> levelFourList = reportView.getTmAlignQueryAccs();
